...
exports.run = async (client, message, args) => {
  if(!message.member.hasPermission("ADMINISTRATOR")) return message.reply("bu komutu kullanmak için `Owner Of  Bruh` yetkisine sahip olmalısın.")
  if(!args[0]) {
